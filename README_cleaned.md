...
## # 🚀 New in Version 2.0.0 (Standalone Release)
...
- **✅ Flexible Configuration**: Use `config.json` or command-line arguments

- **✅ Still Compatible**: Works perfectly with ComfyUI-generated files

- **✅ Simplified Deployment**: Just Python + pip install

- **✅ Universal**: Can point to any folder with AI-generated media
